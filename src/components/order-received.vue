                ...
                <div class="media">
                  ...
                  <div class="media-body ml-4d875">
                    ...
                    <h2 class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2">
                      <a href="index.html#" class="text-dark">The Ride of a Lifetime: Lessons Learned from 15 Years as
                        CEO</a>
                    </h2>
                    <div class="font-size-2 mb-1 text-truncate"><a href="index.html#" class="text-gray-700">Robert
                      Iger</a></div>
                ...
                <div class="media">
                  ...
                  <div class="media-body ml-4d875">
                    <div class="text-primary text-uppercase font-size-1 mb-1 text-truncate"><a href="index.html#">Hard
                      Cover</a></div>
                    <h2 class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2">
                      <a href="index.html#" class="text-dark">The Rural Diaries: Love, Livestock, and Big Life Lessons
                        Down</a>
                    </h2>
                    <div class="font-size-2 mb-1 text-truncate"><a href="index.html#" class="text-gray-700">Hillary
                      Burton</a></div>
                    <div class="price d-flex align-items-center font-weight-medium font-size-3">
              ...
              <div class="px-4 py-5 px-md-6 border-bottom">
                <div class="media">
                  <a href="index.html#" class="d-block"><img src="https://placehold.it/100x153" class="img-fluid"
                                                             alt="image-description"></a>
                  <div class="media-body ml-4d875">
                    <div class="text-primary text-uppercase font-size-1 mb-1 text-truncate"><a href="index.html#">Paperback</a>
                    </div>
                    <h2 class="woocommerce-loop-product__title h6 text-lh-md mb-1 text-height-2 crop-text-2">
                      <a href="index.html#" class="text-dark">Russians Among Us: Sleeper Cells, Ghost Stories, and the
                        Hunt.</a>
                    </h2>
                    <div class="font-size-2 mb-1 text-truncate"><a href="index.html#" class="text-gray-700">Gordon
                      Corera</a></div>
                    <div class="price d-flex align-items-center font-weight-medium font-size-3">
      ...
      <div class="container">
        ...
        <div class="max-width-890 mx-auto">
          <div class="bg-white pt-6 border">
            <h6 class="font-size-3 font-weight-medium text-center mb-4 pb-xl-1">Thank you. Your order has been received.
            </h6>
          ...
          <div class="row">
            ...
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">About
                    as</a>
                </li>
                <li class="py-2">
                ...
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Sign
                    in/Join</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Help
                    Center</a>
                </li>
                <li class="py-2">
                ...
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Product
                    Recalls</a>
                </li>
                <li class="py-2">
                ...
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Contact
                    Us</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Store
                    Pickup</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Return
                    Policy</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Terms
                    Of Use</a>
                </li>
                <li class="py-2">
            ...
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="order-received.html#">Romantic
                    Comedy</a>
                </li>
              </ul>
            </div>
