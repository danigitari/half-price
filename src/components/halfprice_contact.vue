      ...
      <div class="container-fluid px-2 px-md-5 px-xl-8d75">
        <div class="topbar__nav d-md-flex justify-content-between align-items-center">
          <ul class="topbar__nav--left nav ml-md-n3">
            <li class="nav-item"><a class="nav-link link-black-100"><i class="glph-icon flaticon-question mr-2"></i>Can
              we help you?</a></li>
          ...
          <ul class="topbar__nav--right nav mr-md-n3">
            ...
            <li class="nav-item">
              ...
              <a id="sidebarNavToggler1" href="javascript:;" role="button"
                ...
                <span
                    class="position-absolute bg-dark width-16 height-16 rounded-circle d-flex align-items-center justify-content-center text-white font-size-n9 right-0"> {{ books_in_cart }}</span>
          ...
          <div class="site-navigation mr-auto d-none d-xl-block">
            <ul class="nav">
              ...
              <li class="nav-item"><a @click="goToContact"
                                      class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium border-bottom border-primary border-width-2">Contact
                Us</a></li>
            </ul>
          </div>
...
Remember me
              ...
              <div v-else>
                <div class="woocommerce-mini-cart__empty-message pt-2 text-center">
                  <img
                      ...
                      width="40" class="d-inline-block mb-2" alt="Empty cart">
  ...
  <main id="content">
    ...
    <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3988.819095872331!2d36.81972411426504!3d-1.2823354990646956!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x182f11c24baf9073%3A0x1b05ff0d7499371a!2sHalf%20Priced%20Books!5e0!3m2!1sen!2ske!4v1649325124452!5m2!1sen!2ske"
            ...
            <div class="bg-white mt-n10 mt-md-n13 pt-5 pt-lg-7 px-3 px-md-5 pl-xl-10 pr-xl-3">
              <div class="ml-xl-4">
                <div class="mb-4 mb-lg-7">
                  ...
                  <p class="font-weight-medium font-italic">We will answer any questions you may have about our online
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-12 mb-5">
                        <div class="js-form-message">
                          ...
                          <input id="exampleFormControlInput3" type="email" class="form-control rounded-0" name="email"
                                 aria-label="jackwayley@gmail.com" required=""
                                 data-msg="Please enter a valid email address." data-error-class="u-has-error"
                                 data-success-class="u-has-success">
                        </div>
                      ...
                      <div class="col-sm-12 mb-5">
                        <div class="js-form-message">
                          <div class="input-group flex-column">
                            <label for="exampleFormControlInput4">Details please! Your review helps other
                              shoppers.</label>
                            <textarea id="exampleFormControlInput4"
                                      class="form-control rounded-0 pl-3 font-size-2 placeholder-color-3" rows="6"
                                      cols="77" name="text"
