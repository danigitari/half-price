          ...
          <div class="u-sidebar__body">
            <div class="u-sidebar__content u-header-sidebar__content">
              ...
              <div class="px-4 py-5 px-md-6 border-bottom" v-for="book in books" :key="book.id">
                <div class="media">
                  <a href="index.html#" class="d-block"><img src="" class="img-fluid"
              ...
              <div class="px-4 py-5 px-md-6 d-flex justify-content-between align-items-center font-size-3">
                ...
                <div class="font-weight-medium"> KES {{ subtotal }}</div>
              </div>
              <div class="px-4 mb-8 px-md-6">
                ...
                <button type="submit" class="btn btn-block py-4 rounded-0 btn-dark"
                        @click="completePayment">Checkout
                </button>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="d-md-flex justify-content-between align-items-center py-4">
        ...
        <nav class="woocommerce-breadcrumb font-size-2">
          <a href="cart.html#" class="h-primary">Home</a>
          <span class="breadcrumb-separator mx-1"><i class="fas fa-angle-right"></i></span>
          <a href="cart.html#" class="h-primary">Shop</a>
                    ...
                    <table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents">
                      ...
                      <tr class="woocommerce-cart-form__cart-item cart_item" v-for="book in books" :key="book.id">
                        ...
                        <td class="product-subtotal" data-title="Total">
                          <span class="woocommerce-Price-amount amount"><span
                              class="woocommerce-Price-currencySymbol">£</span>{{ book.quantity * book.price }}</span>
                        </td>
                        <td class="product-remove">
                          <a href="cart.html#" class="remove" aria-label="Remove this item">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
          ...
          <div id="cartAccordion" class="border border-gray-900 bg-white mb-5">
            <div class="p-4d875 border">
              <div id="cartHeadingOne" class="cart-head">
                <a class="d-flex align-items-center justify-content-between text-dark" href="cart.html#"
            ...
            <div class="p-4d875 border">
              ...
              <div id="cartCollapseTwo" class="mt-4 cart-content collapse show" aria-labelledby="cartHeadingTwo"
                ...
                <span class="font-size-2">Shipping to Turkey.</span><a href="cart.html#"
...
1418 River Drive, Suite 35 Cottonhall, CA 9622 <br> United States
                ...
                <ul class="list-unstyled mb-0 d-flex">
                  <li class="btn pl-0">
                    <a class="link-black-100" href="cart.html#">
            ...
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">About as</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Sitemap</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="cart.html#">Bookmarks</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Sign
                    in/Join</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Help
                    Center</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Returns</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Product
                    Recalls</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Accessibility</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Contact
                    Us</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Store
                    Pickup</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Return
                    Policy</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Terms Of
                    Use</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Security</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Privacy</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Action</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Comedy</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Drama</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Horror</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Kids</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="cart.html#">Romantic
                    Comedy</a>
                </li>
              </ul>
            </div>
