          ...
          <div class="u-sidebar__body">
            <div class="u-sidebar__content u-header-sidebar__content">
              ...
              <div class="px-4 mb-8 px-md-6">
                ...
                <button type="submit" class="btn btn-block py-4 rounded-0 btn-dark" @click="completePayment">Checkout
                </button>
              </div>
            </div>
          </div>
                ...
                <div id="collapseExample9" class="collapse checkout_coupon mt-4 p-4 bg-white border">
                  <div class="row d-flex">
                    <p class="col-md-4 d-inline form-row form-row-first mb-3 mb-md-0">
                      <input type="text" name="coupon_code1" class="input-text form-control" placeholder="Coupon code"
                             id="coupon_code1" value="">
                    </p>
                    <p class="col-md-3 d-inline form-row form-row-last">
                      <input type="submit" class="button form-control border-0 height-4 btn btn-dark rounded-0"
                ...
                <div name="checkout" class="checkout woocommerce-checkout row mt-8" enctype="multipart/form-data"
                      ...
                      <div class="woocommerce-billing-fields">
                        ...
                        <div class="woocommerce-billing-fields__field-wrapper row">
                          ...
                          <p class="col-12 mb-4d75 form-row form-row-wide address-field update_totals_on_change validate-required woocommerce-validated"
                            ...
                            <label for="billing_country" class="form-label">Country <abbr class="required"
                                                                                          title="required">*</abbr></label>
                            <select v-model="billingformData.country" name="billing_country" id="billing_country"
                          ...
                          <p class="col-12 mb-3 form-row form-row-wide address-field validate-required"
                            ...
                            <label for="billing_address_1" class="form-label">Street address <abbr class="required"
                                                                                                   title="required">*</abbr></label>
                            <input v-model="billingformData.street" type="text" class="input-text form-control"
                          ...
                          <p class="col-12 mb-4d75 form-row form-row-wide address-field validate-required"
                            ...
                            <label for="billing_city" class="form-label">Town / City <abbr class="required"
                                                                                           title="required">*</abbr></label>
                            <input v-model="billingformData.city" type="text" class="input-text form-control"
                                   name="billing_city" id="billing_city" placeholder="" autocomplete="address-level2">
                          </p>
                          ...
                          <p class="col-12 mb-4d75 form-row form-row-first validate-required validate-phone"
                            ...
                            <input v-model="billingformData.phone" type="tel" class="input-text form-control"
                                   name="billing_phone" id="billing_phone" placeholder="" autocomplete="tel">
                          </p>
                          <p class="col-12 mb-4d75 form-row form-row-last validate-required validate-email"
                             id="billing_email_field" data-priority="110">
                            <label for="billing_email" class="form-label">Email address <abbr class="required"
                                                                                              title="required">*</abbr></label>
                            <input v-model="billingformData.email" type="email" class="input-text form-control"
                                   name="billing_email" id="billing_email" placeholder="" autocomplete="email">
                          </p>
                        </div>
                      </div>
                    </div>
                  ...
                  <div id="order_review" class="col-md-6 col-lg-5 col-xl-4 woocommerce-checkout-review-order">
                    <div id="checkoutAccordion" class="border border-gray-900 bg-white mb-5">
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingOnee" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between"
                      ...
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingTwo" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between"
                             data-toggle="collapse" data-target="#checkoutCollapseTwo" aria-expanded="false"
                        ...
                        <div id="checkoutCollapseTwo" class="mt-4 checkout-content collapse"
                          ...
                          <span class="font-size-2">Shipping to Turkey.</span><a href="checkout.html#"
                      ...
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingThree" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between"
                             data-toggle="collapse" data-target="#checkoutCollapseThree" aria-expanded="true"
                    ...
                    <div class="form-row place-order">
                      <button @click="showPaymentModal" class="button alt btn btn-dark btn-block rounded-0 py-4"
...
1418 River Drive, Suite 35 Cottonhall, CA 9622 <br> United States
            ...
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">About
                    as</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Sitemap</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Bookmarks</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Sign
                    in/Join</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Help
                    Center</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Returns</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Product
                    Recalls</a>
                </li>
                <li class="py-2">
                ...
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Contact
                    Us</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Store
                    Pickup</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Return
                    Policy</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Terms Of
                    Use</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Security</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Privacy</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Action</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Comedy</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Drama</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100"
                     href="checkout.html#">Horror</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Kids</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Romantic
                    Comedy</a>
                </li>
              </ul>
            </div>
