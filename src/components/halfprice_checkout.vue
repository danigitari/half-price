<template>
  <div id="payment-modal" class="modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl" style="width: 800px;height: 300px ">
          ...
          <div class="site-navigation mr-auto d-none d-xl-block">
            <ul class="nav">
              <li class="nav-item active">
                <a href="index.html#" class="nav-link link-black-100 mx-4 px-0 py-5 active font-weight-medium d-flex align-items-center ">
                  Home
                </a>
              ...
              <li class="nav-item dropdown">
                <a id="shopDropdownInvoker" href="shop.html" class="dropdown-toggle nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium d-flex align-items-center border-bottom border-primary border-width-2" aria-haspopup="true" aria-expanded="false" data-unfold-event="hover" data-unfold-target="#shopDropdownMenu" data-unfold-type="css-animation" data-unfold-duration="200" data-unfold-delay="50" data-unfold-hide-on-scroll="true" data-unfold-animation-in="slideInUp" data-unfold-animation-out="fadeOut">
                  Shop
                </a>
              ...
              <li class="nav-item"><a href="about.html" class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium">About Us</a></li>

              <li class="nav-item"><a href="contact.html" class="nav-link link-black-100 mx-4 px-0 py-5 font-weight-medium">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div class="u-sidebar__body">
            <div class="u-sidebar__content u-header-sidebar__content">
              ...
              <div class="px-4 py-5 px-md-6 border-bottom" v-for="book in books" :key="book.id">
                <div class="media">
                  ...
                  <div class="media-body ml-4d875">
                    ...
                    <div class="font-size-2 mb-1 text-truncate"><a href="index.html#" class="text-gray-700"> {{ book.author }}</a></div>
              ...
              <div class="px-4 mb-8 px-md-6">
                ...
                <button type="submit" class="btn btn-block py-4 rounded-0 btn-dark" @click="completePayment">Checkout</button>
              </div>
            </div>
          </div>
    ...
    <div class="container">
      <div class="d-md-flex justify-content-between align-items-center py-4">
        ...
        <nav class="woocommerce-breadcrumb font-size-2">
          <a href="checkout.html#" class="h-primary">Home</a>
          <span class="breadcrumb-separator mx-1"><i class="fas fa-angle-right"></i></span>
          <a href="checkout.html#" class="h-primary">Shop</a>
                ...
                <div name="checkout"  class="checkout woocommerce-checkout row mt-8"  enctype="multipart/form-data" novalidate="novalidate">
                  ...
                  <div id="order_review" class="col-md-6 col-lg-5 col-xl-4 woocommerce-checkout-review-order">
                    <div id="checkoutAccordion" class="border border-gray-900 bg-white mb-5">
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingOnee" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#checkoutCollapseOnee" aria-expanded="true" aria-controls="checkoutCollapseOnee">
                        ...
                        <div id="checkoutCollapseOnee" class="mt-4 checkout-content collapse show" aria-labelledby="checkoutHeadingOnee" data-parent="#checkoutAccordion">
                          <table class="shop_table woocommerce-checkout-review-order-table">
                            ...
                            <tbody>
                            <tr class="cart_item" v-for="book in books" :key="book.id">
                              <td class="product-name">
                                {{ book.title }} <strong class="product-quantity">× {{ book.quantity }}</strong>
                              </td>
                              <td class="product-total">
                                <span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>{{ book.price * book.quantity }}</span>
                              </td>
                            </tr>
                            ...
                            <tr class="cart-subtotal">
                              <th>Subtotal</th>
                              <td><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>{{ subtotal }}</span></td>
                            </tr>
                            <tr class="order-total">
                              <th>Total</th>
                              <td><strong><span class="woocommerce-Price-amount amount"><span class="woocommerce-Price-currencySymbol">£</span>{{ subtotal }}</span></strong> </td>
                            </tr>
                            </tfoot>
                          </table>
                        </div>
                      ...
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingOne" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#checkoutCollapseOne" aria-expanded="true" aria-controls="checkoutCollapseOne">
                      ...
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingTwo" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#checkoutCollapseTwo" aria-expanded="false" aria-controls="checkoutCollapseTwo">
                        ...
                        <div id="checkoutCollapseTwo" class="mt-4 checkout-content collapse" aria-labelledby="checkoutHeadingTwo" data-parent="#checkoutAccordion">
                          ...
                          <span class="font-size-2">Shipping to Turkey.</span><a href="checkout.html#" class="font-weight-medium h-primary ml-3 font-size-2">Change Address</a>
                        </div>
                      </div>
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingThree" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#checkoutCollapseThree" aria-expanded="true" aria-controls="checkoutCollapseThree">
                      ...
                      <div class="p-4d875 border">
                        <div id="checkoutHeadingThreee" class="checkout-head">
                          <a href="checkout.html#" class="text-dark d-flex align-items-center justify-content-between" data-toggle="collapse" data-target="#checkoutCollapseThreee" aria-expanded="true" aria-controls="checkoutCollapseThreee">
                    ...
                    <div class="form-row place-order">
                      <button @click="showPaymentModal" class="button alt btn btn-dark btn-block rounded-0 py-4" name="place_order" id="place_order">
                        <a  style="color:#fff">Place Order</a>
                      </button>
                    </div>
                  </div>
                </div>
...
1418 River Drive, Suite 35 Cottonhall, CA 9622 <br> United States
                ...
                <ul class="list-unstyled mb-0 d-flex">
                  <li class="btn pl-0">
                    <a class="link-black-100" href="checkout.html#">
            ...
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">About as</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Sitemap</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Bookmarks</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Sign in/Join</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Help Center</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Returns</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Product Recalls</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Accessibility</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Contact Us</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Store Pickup</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Return Policy</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Terms Of Use</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Security</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Privacy</a>
                </li>
              </ul>
            </div>
            <div class="col-lg-2 mb-6 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                <li class="pb-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Action</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Comedy</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Drama</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Horror</a>
                </li>
                <li class="py-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Kids</a>
                </li>
                <li class="pt-2">
                  <a class="widgets-hover transition-3d-hover font-size-2 link-black-100" href="checkout.html#">Romantic Comedy</a>
                </li>
              </ul>
            </div>
          </div>
