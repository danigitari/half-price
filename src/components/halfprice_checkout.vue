      ...
      <div class="modal-content">
        ...
        <div class="modal-body ">
          <div style="font-size: 15px">
            Please enter payment message reference code
          </div>
          <div class=" " style="font-size: 15px">
                ...
                <div class="zeynep pt-4">
                  <ul>
                    <li class="has-submenu" v-for="(category,index) in categories" :key="index">
                      <a href="#" data-submenu="off-pages">{{ category }}</a>
                          ...
                          <table class="shop_table woocommerce-checkout-review-order-table">
                            ...
                            <tr class="cart_item" v-for="book in books" :key="book.id">
                              <td class="product-name">
                                {{ book.name }} <strong class="product-quantity">× {{ book.quantity }}</strong>
                              </td>
                            ...
                            <tr class="order-total">
                              ...
                              <td><strong><span class="woocommerce-Price-amount amount"><span
                                  class="woocommerce-Price-currencySymbol">Ksh </span>{{ subtotal }}</span></strong>
                              </td>
                            </tr>
                            </tfoot>
                          </table>
...
export default defineComponent({
  ...
  setup() {
    ...
    const showPaymentModal = () => {
      ...
      if (billingformData.subtotal && billingformData.lastname && billingformData.firstname && billingformData.street && billingformData.phone && billingformData.email && billingformData.country) {
