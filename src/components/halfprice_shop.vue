        ...
        <div id="primary" class="content-area order-2">
          <div class="shop-control-bar d-lg-flex justify-content-between align-items-center mb-5 text-center text-md-left">
            <div class="shop-control-bar__left mb-4 m-lg-0">
              <p v-if="searching" class="woocommerce-result-count m-0">Showing 1 – {{ totalSearchProducts }}  of {{ totalSearchProducts }} results</p>
              <p v-else class="woocommerce-result-count m-0">Showing 1 – {{ totalProducts }}  of {{ totalProducts }} results</p>
            </div>
          ...
          <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active" id="pills-one-example1" role="tabpanel" aria-labelledby="pills-one-example1-tab">
              ...
              <ul class="products list-unstyled row no-gutters row-cols-2 row-cols-lg-4 row-cols-wd-4 border-top border-left mb-6">
                <li class="product col" v-for="product in searchProducts" :key="product.id">
                  <div class="product__inner overflow-hidden p-3 p-md-4d875">
                    <div class="woocommerce-LoopProduct-link woocommerce-loop-product__link d-block position-relative">
                      ...
                      <div class="woocommerce-loop-product__body product__body pt-3 bg-white">
                        ...
                        <h2 class="woocommerce-loop-product__title product__title h6 text-lh-md  text-height-2 crop-text-2 h-dark"><a >{{ product.name}}</a></h2>
                      ...
                      <div class="product__hover d-flex align-items-center">
                        <a  class="text-uppercase text-dark h-dark font-weight-medium mr-auto" data-toggle="tooltip" data-placement="right" title="" data-original-title="ADD TO CART">
                          ...
                          <a  class="mr-1 h-p-bg btn btn-outline-primary border-0"><i  @click="addToCart(product)"  class="flaticon-icon-126515"></i></a>
                        </a>
...
import Home from "./halfprice_home"


export default defineComponent({
  name : 'Shop',
  props: ['home_search_term'],
  components : {
    Home,
  },
  setup: function (props) {
    ...
    onMounted(() => {
      ...
      fetchCategories()
      fetchBooks()
      console.log(props.home_search_term)
      if(props.home_search_term){
        search_term.value = props.home_search_term
